...
export const TRAITS: Trait[] = [
    ...
    {name: 'Vulpes', species: Species.VAYRON, type: TraitType.EAR, rarity: Rarity.COMMON},
    {name: 'Bear', species: Species.VAYRON, type: TraitType.EAR, rarity: Rarity.COMMON},
    {name: 'Peep', species: Species.VAYRON, type: TraitType.EAR, rarity: Rarity.COMMON},
    ...
    {name: 'Loopy', species: Species.VAYRON, type: TraitType.EAR, rarity: Rarity.UNCOMMON},
    {name: 'Draco', species: Species.VAYRON, type: TraitType.EAR, rarity: Rarity.UNCOMMON},
    {name: 'Feathered', species: Species.VAYRON, type: TraitType.EAR, rarity: Rarity.UNCOMMON},
    ...
    {name: 'Large Draco', species: Species.VAYRON, type: TraitType.EAR, rarity: Rarity.RARE},
    {name: 'Dumbo', species: Species.VAYRON, type: TraitType.EAR, rarity: Rarity.RARE},
    {name: 'Antennae', species: Species.VAYRON, type: TraitType.EAR, rarity: Rarity.RARE},


    //TYRIAN TAILS
    {name: 'Tuft Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.COMMON},
    {name: 'Spear Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.COMMON},
    {name: 'Flap Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.COMMON},

    {name: 'Ribbed Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.UNCOMMON},
    {name: 'Ridged Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.UNCOMMON},
    {name: 'Quill Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.UNCOMMON},

    {name: 'Persian Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.RARE},
    {name: 'Frilled Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.RARE},
    {name: 'Veil Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.RARE},

    {name: 'Flat Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.VERY_RARE},
    {name: 'Bulb Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.VERY_RARE},
    {name: 'Cape Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.VERY_RARE},
    {name: 'Sprout Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.VERY_RARE},
    {name: 'Club Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.VERY_RARE},
    {name: 'Scorpion Tail', species: Species.VAYRON, type: TraitType.TAIL, rarity: Rarity.VERY_RARE},
